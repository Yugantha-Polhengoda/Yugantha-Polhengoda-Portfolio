...
const NavBar = () => {
  return (
    <header className="fixed shadow-custom-shadow top-0 z-[999] w-full backdrop-blur-sm">
        ...
        <h4 className='flex gap-1 font-Poppins-font text-custom-xs font-light border border-white rounded-full py-1 pr-3 pl-3 mb-1 md:pr-3 md:pl-4 md:text-xs lg:pr-3 lg:pl-4 lg:text-xs 2xl:pr-3 2xl:pl-4 2xl:text-xs'>Yugantha Polhengoda<div className="pluseDot2"></div><div className="pluseDot3"></div><div className="pluseDot"></div></h4>
