  ...
  return (
    <header className="fixed shadow-custom-shadow top-0 z-[999] w-full backdrop-blur-sm">
        ...
        <div className="text-base items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
            ...
            <li>
                <a href="#" className="block py-2 px-3 text-cyan-600 bg-cyan-600 rounded hover:scale-125 transition-transform duration-200 md:bg-transparent md:hover:text-cyan-600 md:text-white md:p-0 md:dark:text-white font-Poppins-font" aria-current="page">Home</a>
            </li>
            <li>
