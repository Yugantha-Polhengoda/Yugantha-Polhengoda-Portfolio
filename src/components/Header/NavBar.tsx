...
const NavBar = () => {
  return (
    <header className="fixed shadow-custom-shadow top-0 z-[999] w-full backdrop-blur-sm">
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto pl-4 mr-4 md:pl-8 md:pr-8 md:pt-5 md:pb-5 lg:pt-5 lg:pb-5 2xl:mr-40 2xl:pt-5 2xl:pl-0 2xl:pr-0 2xl:pb-5">
        <h4 className='flex gap-1 font-Poppins-font text-custom-xs font-light border border-white rounded-full py-1 pr-2 pl-3 mb-1 md:pr-3 md:pl-4 md:text-xs lg:pr-3 lg:pl-4 lg:text-xs 2xl:pr-3 2xl:pl-4 2xl:text-xs'>Yugantha Polhengoda<div className="pluseDot2"></div><div className="pluseDot3"></div><div className="pluseDot"></div></h4>
        ...
        <div className="text-base items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
            ...
            <li>
                <a href="#" className="block py-2 px-3 text-white bg-cyan-600 rounded hover:scale-125 transition-transform duration-200 md:bg-transparent md:hover:text-cyan-600 md:text-white md:p-0 md:dark:text-white font-Poppins-font" aria-current="page">Home</a>
            </li>
            <li>
                <a href="#" className="block py-2 px-3 text-white rounded hover:scale-125 transition-transform duration-200 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-cyan-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700  font-Poppins-font">About</a>
            </li>
            <li>
                <a href="#" className="block py-2 px-3 text-white hover:scale-125 transition-transform duration-200 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-cyan-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 font-Poppins-font">Projects</a>
            </li>
            <li>
                <a href="#" className="block py-2 px-3 text-white rounded hover:scale-125 transition-transform duration-200 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-cyan-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 font-Poppins-font">Contact</a>
            </li>
            </ul>
        </div>
        </div>
