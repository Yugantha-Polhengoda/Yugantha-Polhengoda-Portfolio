          ...
          <Image src={ProfileImg} alt="Profile Image" className=' w-52 ml-9 md:w-52 md:h-52 md:ml-8 lg:w-72 lg:h-72 lg:ml-0 2xl:w-72 2xl:ml-0'/>
            <div className="mt-4 lg:absolute md:ml-5 md:mt-5 lg:ml-80 lg:mt-14 2xl:ml-80 2xl:mt-12">
                ...
                <div className="flex pb-4 gap-3 2xl:mt-5">
                    <a href="/public/Images/Yugantha_TotalCV.pdf" download className="inline-flex items-center px-6 py-2 border border-transparent text-sm 2xl:text-lg font-medium rounded-md shadow-sm text-zinc-800 bg-white hover:bg-gray-200 hover:text-black group">
                    <FaDownload size={18} className="phone-Icon mr-2" />
                        Resume
                    </a>

                    <a href="tel:+94767801452" className="inline-flex items-center px-6 py-2 border border-white text-sm 2xl:text-lg font-medium rounded-md shadow-sm text-white bg-transparent hover:bg-white hover:text-zinc-800 group">
