...
const Experience = () => {
  return (
    <div className="p-8 pb-0 justify-center 2xl:mt-16 2xl:p-32 2xl:pb-0 flex flex-wrap text-white font-Poppins-font 2xl:justify-between items-center">
      ...
      <div className="gap-1 2xl:gap-0 flex 2xl:flex-col 2xl:mb-20 2xl:ml-24">
      ...
      <div className="flex flex-wrap text-white justify-between items-center gap-18">
        ...
        <div>
          <img className="mb-32 2xl:ml-11" src={Icon3D2.src} alt="3D2" width="500px"/>
        </div>
      </div>
    </div>
  )
