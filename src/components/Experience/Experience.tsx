  ...
  return (
    <div className="p-8 justify-center 2xl:mt-16 2xl:p-32 flex flex-wrap text-white 2xl:justify-between items-center">
      <div className="mb-10 2xl:mb-32">
        <h4 className='languages-t text-custom-xs ml-10 w-40 font-semibold border border-white rounded-full py-1 pl-5 mb-1 2xl:text-xs 2xl:w-56 2xl:ml-10'>Web Development & Languages</h4>
      ...
      <div className="gap-1 2xl:gap-0 flex 2xl:flex-col 2xl:mb-20 2xl:ml-36">
        <h4 className="w-20 text-center text-xs bg-white text-black rounded-lg 2xl:w-36 font-bold p-2 mb-2 2xl:text-custom-sm">
          <img className="w-7 inline mr-2" src={htmlIcon.src} alt="HTML"/>HTML
        </h4>
        <h4 className="w-20 text-center text-xs bg-white text-black rounded-lg font-bold p-3 mb-2 2xl:text-custom-sm 2xl:w-36 2xl:p-2">
      ...
      <div className="gap-1 flex 2xl:gap-0 2xl:flex-col mb-20">
        ...
        <h4 className="w-20 text-center text-xs bg-white text-black rounded-lg 2xl:w-36 font-bold p-custom-p mb-2 2xl:text-custom-sm">
      ...
      <div className="flex flex-wrap text-white justify-between items-center gap-18">
        <div className="mb-10 2xl:mb-40">
          <h4 className='languages-t text-custom-xs 2xl:text-xs w-36 font-semibold border border-white rounded-full py-1 ml-10 pl-5 mb-1 2xl:w-48'>3D Modeling & Animation</h4>
